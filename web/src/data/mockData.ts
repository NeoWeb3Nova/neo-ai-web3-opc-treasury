...
export const DIGITAL_EMPLOYEES: DigitalEmployee[] = [
  {
    ...
    recommended_policy: { monthly_budget: 200, single_tx_limit: 50, cooldown_hours: 12 },
  ...
  },
  {
    ...
    recommended_policy: { monthly_budget: 800, single_tx_limit: 200, cooldown_hours: 6 },
...
export const ALL_VENDORS: Vendor[] = [
  ...
  { name: 'OpenAI', address: VENDOR_REGISTRY['OpenAI'], category: 'api', chain: 'Base' },
  { name: 'Midjourney', address: VENDOR_REGISTRY['Midjourney'], category: 'api', chain: 'Base' },
  { name: 'Unsplash', address: VENDOR_REGISTRY['Unsplash'], category: 'api', chain: 'Base' },
  { name: 'Google Ads', address: VENDOR_REGISTRY['Google Ads'], category: 'ads', chain: 'Base' },
  { name: 'Twitter Ads', address: VENDOR_REGISTRY['Twitter Ads'], category: 'ads', chain: 'Base' },
  { name: 'Designer PH', address: VENDOR_REGISTRY['Designer PH'], category: 'outsource', chain: 'Base' },
  { name: 'Translator VN', address: VENDOR_REGISTRY['Translator VN'], category: 'outsource', chain: 'Base' },
  { name: 'AWS', address: VENDOR_REGISTRY['AWS'], category: 'infra', chain: 'Base' },
  { name: 'Vercel', address: VENDOR_REGISTRY['Vercel'], category: 'infra', chain: 'Base' },
];
